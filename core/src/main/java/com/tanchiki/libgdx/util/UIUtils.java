...
public class UIUtils {
    public static TextureRegion[] r = ObjectClass.GameStage.TextureLoader.getIcons()[0];
    ...
    public static Dialog newDialog(String name, Button... buttons) {
        Dialog dialog = new Dialog("", new Window.WindowStyle(FontLoader.f16, Color.WHITE, new TextureRegionDrawable(ObjectClass.GameStage.TextureLoader.getIcons()[0][14])));
