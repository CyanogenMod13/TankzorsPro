...
public class Trigger extends Actor {
	...
	private void function() {
		...
		switch (type) {
			...
			case 3: Function.createBlocks(x, y + 2 * 2, param, true); break;
			case 4:	Function.createBlocks(x + 2 * 2, y, param, false); break;
			
			case 5: Function.explosionNearlyBlock(x, y, 0, -1, param); break;
			case 6: Function.explosionNearlyBlock(x, y, -1, 0, param); break;
			case 7: Function.explosionNearlyBlock(x, y, 0, 1, param); break;
			case 8:	Function.explosionNearlyBlock(x, y, 1, 0, param); break;
			
			case 9: Function.activateSpawnPoint(param); break;
			case 10: Function.disactivateSpawnPoint(param); break;
			case 11: Function.switchActiveModeSpawnPoint(param); break;
			
			case 15: Function.activateSpawnPointN(this, x, y, param); break;
			case 16: Function.disactivateSpawnPointN(this, x, y, param); break;
			case 17: Function.switchActiveModeSpawnPointN(x, y, param); break;	
			
			case 12: 
			case 18: Function.invokeAirplane(x, y, param); break;
			case 19: Function.makeExplosion(x, y, param); break;	
			...
			case 25:
			case 26:
			case 27: Function.showToast(type - 20); break;	
			
			case 31: Function.activateTrigger(this, param); break;
			case 32: Function.activateTriggersN(this, x, y, param); break;	
			
			case 20: Function.makeWin(this, param); break;
			
			case 33: Function.enableTrigger(param); break;
			case 34: Function.disableTrigger(param); break;
			case 35: Function.switchModeTrigger(param); break;
			
			case 36: Function.enableTriggersN(x, y, param); break;
			case 37: Function.disableTriggersN(x, y, param); break;
			case 38: Function.switchModeTriggersN(x, y, param); break;
	...
	public static class Function {
		...
		private static Block createBlock(int x, int y, int type) {
			switch (type) {
				...
				case 8:
				case 9:
				case 10: return new StoneWall(x, y);
				case 2: return new Concrete1Wall(x, y);
				case 3: return new Concrete3Wall(x, y);
				case 4: return new BlueIronWall(x, y);
				case 5: return new OrangeIronWall(x, y);
				case 6: return new Cactus(x, y);
				case 7: return new SmallTree(x, y);
				case 11: return new Spike(x, y);
			}
			return null;
		}
		...
		public static void switchActiveModeSpawnPoint(int param) {
			...
			if (num == 0) {
				if (allies)
					for (int key : AngarUnity.register.keySet()) AngarUnity.register.get(key).activity = AngarUnity.register.get(num).activity == 1 ? 0 : 1;
				else 
					for (int key : AngarEnemy.register.keySet()) AngarEnemy.register.get(key).activity = AngarEnemy.register.get(num).activity == 1 ? 0 : 1;
			} else {
				if (allies)
		...
		public static void switchModeTriggersN(int x0, int y0, int param) {
			...
			for (int key : Trigger.register.keySet()) {
				Trigger trigger = Trigger.register.get(key);
				if (rect.contains(trigger.getX(Align.center), trigger.getY(Align.center))) trigger.enabled = !trigger.enabled;
			}
		}
	}
}
