...
public class BulletPlusma extends Bullet {
    public BulletPlusma(float x, float y, int angle, float f) {
        super(x, y, angle, 2 / 3f, f, new Array<>(new TextureRegion[]{
                TextureLoader.getInstance().getBullets()[0][4],
                TextureLoader.getInstance().getBullets()[0][5],
                TextureLoader.getInstance().getBullets()[0][6],
                TextureLoader.getInstance().getBullets()[0][7]}));
        ID = 2;
